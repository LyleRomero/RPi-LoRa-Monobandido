...
//******************************************************************** */
let portName = '/dev/ttyS1';
//let portOuput = '/dev/ttyS0';
...
//console.log(data)
	...
	https.get('https://script.google.com/macros/s/AKfycbxavAVXJcH_PPHrIlw7VCif8eRI382OflSrxmtexTXavfQBX5qnZpnsCmx_XiyaLU2qmQ/exec?idSede=' + leerDatos[0] + '&idSensor=' + leerDatos[1] + '&valorSensor=' + leerDatos[2] )
	//console.log('SE ENVIO GET')	
}
